      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
        <div className="flex flex-col gap-10">
          <div className="text-center">
            <p className="text-sm uppercase tracking-[0.35em] text-emerald-400">Benefits</p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <div className="space-y-6 rounded-[2rem] border border-white/[0.05] bg-neutral-950/40 p-8">
              ...
              <div className="space-y-4">
                <p className="text-sm uppercase tracking-[0.35em] text-emerald-400">For Contributors</p>
            ...
            <div className="space-y-6">
              <div className="rounded-[2rem] border border-white/[0.05] bg-neutral-950/40 p-8">
                <div className="space-y-4">
                  <p className="text-sm uppercase tracking-[0.35em] text-emerald-400">For Organisations</p>
                  <ul className="space-y-3 text-sm leading-7 text-neutral-200">
